...
// Same reasoning as Select (components/ui/select.tsx): Radix defaults this
// to modal={true}, which locks/hides the page scrollbar for as long as the
// menu is open. modal={false} keeps it visible and the page scrollable;
// callers can still override by passing their own `modal` prop.
