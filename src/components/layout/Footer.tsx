      ...
      <div className="px-5 sm:px-10 md:px-20 max-w-[1400px] mx-auto py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-10 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 md:mt-4 text-[14px] text-muted-foreground max-w-xs leading-[1.7]">{t("footer_tagline")}</p>
          ...
          {/* Shop links */}
          <div>
            <h4 className="text-[11px] font-bold uppercase tracking-[0.15em] text-foreground mb-4 md:mb-6">{t("nav_products")}</h4>
          ...
          {/* Assistance */}
          <div>
            <h4 className="text-[11px] font-bold uppercase tracking-[0.15em] text-foreground mb-4 md:mb-6">{t("nav_location")}</h4>
            <ul className="space-y-2.5 md:space-y-3">
          ...
          {/* Studio */}
          <div className="col-span-2 md:col-span-1">
            <h4 className="text-[11px] font-bold uppercase tracking-[0.15em] text-foreground mb-4 md:mb-6">{t("address")}</h4>
            <p className="text-[14px] text-muted-foreground leading-relaxed mb-4">{settings?.address || "Nazareth, Israel"}</p>
            <Link to="/services">
