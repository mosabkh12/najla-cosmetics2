...
import { Minus, Plus, Trash2, ShoppingBag, ChevronLeft, Truck, ShieldCheck, ArrowLeft } from "lucide-react";
    ...
    return (
      <section className="min-h-[calc(100vh-160px)] bg-background">
        <div className="px-5 sm:px-10 md:px-20 max-w-[1400px] mx-auto py-20 sm:py-32 text-center">
          ...
          <h1 className="mt-6 font-display text-[28px] sm:text-[36px] text-foreground">{t("empty_cart")}</h1>
          <p className="mt-3 text-[15px] text-muted-foreground">{t("products_sub")}</p>
          <Link to="/products">
            <button className="mt-8 bg-foreground text-background px-10 py-4 rounded-full text-[11px] font-semibold uppercase tracking-[0.1em] hover:opacity-90 transition-opacity">
              {t("continue_shopping")}
            </button>
          </Link>
        </div>
          ...
          <div className="lg:sticky lg:top-24">
            ...
            >
              ...
              <Link to="/checkout" className="block">
                <button className="w-full bg-foreground text-background h-[52px] rounded-full text-[11px] font-semibold uppercase tracking-[0.1em] hover:opacity-90 transition-opacity">
                  {t("checkout")}
                </button>
              </Link>

              <Link to="/products" className="block mt-3">
                <button className="w-full bg-primary text-primary-foreground h-[52px] rounded-full text-[11px] font-semibold uppercase tracking-[0.1em] hover:opacity-90 transition-opacity">
                  {t("continue_shopping")}
                </button>
              </Link>
