      ...
      <div className="px-5 sm:px-10 md:px-20 max-w-[1400px] mx-auto py-8 sm:py-12">
        ...
        <Reveal direction="up">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h1 className="font-display text-[30px] sm:text-[40px] text-foreground">
                {t("cart")}
              </h1>
              <p className="mt-1 text-[14px] text-muted-foreground">
                {count} {t("products_title").split(" ")[0]}
              </p>
            </div>
            <Link
              to="/products"
              ...
              <div>
                ...
                <div className="divide-y divide-border/20">
                  {items.map((it) => (
                    <div
                      key={it.product_id}
                      className="py-6 sm:grid sm:grid-cols-[1fr_140px_140px_40px] sm:gap-4 sm:items-center"
                    >
                      {/* Product info */}
                      <div className="flex gap-4">
                        ...
                        <div className="flex flex-col justify-center min-w-0">
                          <h3 className="font-display text-[16px] sm:text-[18px] text-foreground truncate">
                            {it.name}
                          </h3>
                ...
                <div className="space-y-3 pb-5 border-b border-border/20">
                  {items.map((it) => (
                    <div key={it.product_id} className="flex justify-between text-[14px]">
                      <span className="text-muted-foreground truncate me-3">
                        {it.name} × {it.quantity}
                      </span>
