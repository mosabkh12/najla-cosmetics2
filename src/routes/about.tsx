        ...
        <div className="grid gap-6 md:gap-10 md:grid-cols-[1fr_1.1fr] md:items-center overflow-x-hidden">
          <Reveal direction="start">
            <div className="relative">
              <div
                className="aspect-[4/3] sm:aspect-[3/4] md:aspect-[4/5] max-h-[420px] md:max-h-[520px] overflow-hidden rounded-3xl border border-border/40"
          ...
          <Reveal direction="end" delay={2}>
            <div className="mt-4 md:mt-0">
              ...
              <h1 className="mt-4 font-display text-[28px] sm:text-[34px] md:text-[40px] leading-[1.15] text-foreground">
                {t("about_title")}
              </h1>
              <p className="mt-4 text-[15px] leading-[1.8] text-secondary-foreground">
                {t("about_body")}
              </p>
      ...
      <div className="px-5 sm:px-10 md:px-20 max-w-[1400px] mx-auto pb-10 sm:pb-14">
        <StaggerGrid className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {values.map((v, i) => (
            <div
              key={i}
              className="rounded-2xl border border-border/30 bg-card/80 backdrop-blur-sm p-4 sm:p-5 text-center"
            ...
            >
              ...
              <h3 className="mt-3 font-display text-sm sm:text-base text-foreground">
                {v.titleHe}
              </h3>
