...
const HE: Dict = {
  ...
  cookie_notice_text:
    "אנו משתמשים בעוגיות ובאחסון מקומי כדי להפעיל את האתר — לשמור אתכם מחוברים, לזכור את תוכן העגלה שלכם ואת שפת התצוגה המועדפת. אלו חיוניים לפעילות האתר ולא ניתן להשבית אותם. נכון להיום איננו משתמשים בעוגיות פרסום, מעקב או ניתוח סטטיסטי של צד שלישי. תוכלו לבחור לאשר את כל השימוש בעוגיות, או להמשיך עם עוגיות חיוניות בלבד — הבחירה תישמר עבור כלים נוספים ככל שיתווספו בעתיד.",
  cookie_necessary_only: "חיוניים בלבד",
  cookie_accept: "אישור הכל",
  cookie_settings: "הגדרות עוגיות",
  cookie_preference_saved: "ההעדפה שלך נשמרה",
  language: "שפה",
...
const AR: Dict = {
  ...
  cookie_notice_text:
    "نستخدم ملفات تعريف الارتباط والتخزين المحلي لتشغيل الموقع — للحفاظ على تسجيل دخولك، وتذكر محتوى سلة التسوق ولغة العرض المفضلة لديك. هذه ضرورية لعمل الموقع ولا يمكن تعطيلها. لا نستخدم حاليًا أي ملفات تعريف ارتباط للإعلانات أو التتبع أو التحليلات من طرف ثالث. يمكنك اختيار الموافقة على الكل، أو الاكتفاء بالملفات الضرورية فقط — سيُحفظ اختيارك لأي أدوات إضافية تُضاف مستقبلاً.",
  cookie_necessary_only: "الضرورية فقط",
  cookie_accept: "الموافقة على الكل",
  cookie_settings: "إعدادات ملفات تعريف الارتباط",
  cookie_preference_saved: "تم حفظ تفضيلك",
  language: "اللغة",
...
const EN: Dict = {
  ...
  cookie_notice_text:
    "We use cookies and local storage to run this site — to keep you signed in, remember your cart contents, and your preferred display language. These are essential to the site's operation and can't be turned off. We don't currently use any advertising, tracking, or third-party analytics cookies. You can choose to accept all, or continue with necessary cookies only — your choice will be saved for any additional tools added in the future.",
  cookie_necessary_only: "Necessary Only",
  cookie_accept: "Accept All",
  cookie_settings: "Cookie Settings",
  cookie_preference_saved: "Your preference has been saved",
  language: "Language",
