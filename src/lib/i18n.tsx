...
const HE: Dict = {
  ...
  verify_title: "בדקי את האימייל שלך",
  verify_body: "שלחנו קישור אימות ל",
  verify_body2: "לחצי על הקישור באימייל כדי להפעיל את החשבון.",
  verify_resend: "שלחי שוב",
  verify_resent: "האימייל נשלח מחדש!",
...
const AR: Dict = {
  ...
  verify_title: "تحققي من بريدكِ الإلكتروني",
  verify_body: "أرسلنا رابط التحقق إلى",
  verify_body2: "اضغطي على الرابط في البريد لتفعيل حسابكِ.",
  verify_resend: "إعادة الإرسال",
  verify_resent: "تم إعادة إرسال البريد!",
  verify_back: "العودة لتسجيل الدخول",
  verify_check_spam: "لم تستلمي البريد؟ تحققي من مجلد الرسائل غير المرغوب فيها.",
  or_continue_with: "أو",
};
...
const EN: Dict = {
  ...
  verify_body2: "Click the link in the email to activate your account.",
  verify_resend: "Resend email",
  verify_resent: "Verification email resent!",
